#!/bin/bash
#SBATCH --job-name=lora_specialized
#SBATCH -c 2
#SBATCH -n 1
...
python image-classification/run_image_classification.py \
    ...
    --save_total_limit 1 \
    --seed 6 \
    --root_output_dir /n/home04/huandongchang/ElaLoRA/IMAGE_CLASS/lora/cifar_r8_100e \
...
python image-classification/run_image_classification.py \
    ...
    --save_total_limit 1 \
    --seed 6 \
    --root_output_dir /n/home04/huandongchang/ElaLoRA/IMAGE_CLASS/lora/eurosat_r8_100e \
    --overwrite_output_dir
...
python image-classification/run_image_classification.py \
    ...
    --save_total_limit 1 \
    --seed 6 \
    --root_output_dir /n/home04/huandongchang/ElaLoRA/IMAGE_CLASS/lora/resisc45_r8_100e \
    --overwrite_output_dir
...
python image-classification/run_image_classification.py \
    ...
    --save_total_limit 1 \
    --seed 6 \
    --root_output_dir /n/home04/huandongchang/ElaLoRA/IMAGE_CLASS/lora/diabetic_r8_100e \
    --overwrite_output_dir
...
python image-classification/run_image_classification.py \
    ...
    --save_total_limit 1 \
    --seed 6 \
    --root_output_dir /n/home04/huandongchang/ElaLoRA/IMAGE_CLASS/lora/clevr_dist_r8_100e \
    --overwrite_output_dir
...
python image-classification/run_image_classification.py \
    ...
    --save_total_limit 1 \
    --seed 6 \
    --root_output_dir /n/home04/huandongchang/ElaLoRA/IMAGE_CLASS/lora/clevr_count_r8_100e \
    --overwrite_output_dir
