#!/bin/bash
#SBATCH --job-name=elalora_main_v6
#SBATCH -c 2
#SBATCH -n 1
...
python image-classification/run_image_classification.py \
    ...
    --save_total_limit 1 \
    --seed 6 \
    --root_output_dir ./ela/cifar_r8_100e_v6 \
...
python image-classification/run_image_classification.py \
    ...
    --save_total_limit 1 \
    --seed 6 \
    --root_output_dir ./ela/eurosat_r8_100e_v6 \
    --overwrite_output_dir
...
python image-classification/run_image_classification.py \
    ...
    --save_total_limit 1 \
    --seed 6 \
    --root_output_dir ./ela/resisc45_r8_100e_v6 \
    --overwrite_output_dir
...
python image-classification/run_image_classification.py \
    ...
    --save_total_limit 1 \
    --seed 6 \
    --root_output_dir ./ela/svhn_r8_100e_v6 \
    --overwrite_output_dir
