#!/bin/bash
#SBATCH --job-name=elalora_main_v4
#SBATCH -c 2
#SBATCH -n 1
...
python image-classification/run_image_classification.py \
    ...
    --b 4 --k 2 \
    --init_warmup 500 --final_warmup 1500 --mask_interval 150 \
    ...
    --save_total_limit 1 \
    --seed 6 \
    --root_output_dir ./ela/cifar_r8_100e_v4 \
...
python image-classification/run_image_classification.py \
    ...
    --save_total_limit 1 \
    --seed 6 \
    --root_output_dir ./ela/eurosat_r8_100e_v4 \
    --overwrite_output_dir
...
python image-classification/run_image_classification.py \
    ...
    --save_total_limit 1 \
    --seed 6 \
    --root_output_dir ./ela/resisc45_r8_100e_v4 \
    --overwrite_output_dir
...
python image-classification/run_image_classification.py \
    ...
    --save_total_limit 1 \
    --seed 6 \
    --root_output_dir ./ela/svhn_r8_100e_v4 \
    --overwrite_output_dir
